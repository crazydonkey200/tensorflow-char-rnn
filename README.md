...
All the output of this experiment will be saved in a folder (default to output/, you can specify the folder name using `--output_dir=your-output-folder`). The experiment log will be printed to stdout by default. To direct the log to a file instead, use `--log_to_file` (the experiment log will be saved in `your-output-folder/experiment_log.txt`).
